 ...
 ${c}`,c=c.replace("return",`${s} = `);let p=`
    ...
    `),t="packedUVfrom1D",n[t]=new M(`
      ...
      `),t="sampleTexture";let o=q(this.context.glContext.version);return n[t]=new M(`
        ...
        }`),n}getInputsSamplingSnippets(){let n={},t=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((o,i)=>{let a=this.context.inputTextureLayouts[i],s=ko(o);a.isPacked?n[s]=this.getPackedSamplerFromInput(s,o,a):n[s]=this.getUnpackedSamplerFromInput(s,o,a);let u=Vd(o);a.unpackedShape.length<=t.unpackedShape.length&&(a.isPacked?n[u]=this.getPackedSamplerAtOutputCoords(u,a,t,o):n[u]=this.getUnpackedSamplerAtOutputCoords(u,a,t,o))}),n}getPackedSamplerAtOutputCoords(n,t,o,i){let a=t.unpackedShape,s=o.unpackedShape,l=ko(i),c=a.length,d=s.length,p=Xe.getBroadcastDims(a,s),f=Ze(d),h=d-c,m,y=wt();c===0?m="":d<2&&p.length>=1?m="coords = 0;":m=p.map(E=>`coords.${y[E+h]} = 0;`).join(`
`);let g="";d<2&&c>0?g="coords":g=a.map((E,N)=>`coords.${y[N+h]}`).join(", ");let b="return outputValue;",T=F.size(a)===1,I=F.size(s)===1;if(c===1&&!T&&!I)b=`
    ...
    `;return new M(O,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(n,t,o,i){let a=[o.width,o.height],s=[t.width,t.height],u=t.unpackedShape.length,l=o.unpackedShape.length,c=t.unpackedShape,d=o.unpackedShape,p=ko(i);if(u===l&&Hn.arraysEqual(s,a)){let T=`
        ...
        `;return new M(T,["coordinates.sampleTexture"])}let f=Ze(l),h=Xe.getBroadcastDims(c,d),m=l-u,y,g=wt();u===0?y="":l<2&&h.length>=1?y="coords = 0;":y=h.map(T=>`coords.${g[T+m]} = 0;`).join(`
`);let b="";l<2&&u>0?b="coords":b=t.unpackedShape.map((T,w)=>`coords.${g[w+m]}`).join(", ");let _=`
      ...
      return ${s.texture2D}(${t}, uv);
    }`;return new M(f,["coordinates.packedUVfrom2D"])}getPackedSampler3D(n,t,o){let i=o.unpackedShape,a=[o.width,o.height],s=[a[0],a[1]],u=q(this.context.glContext.version);if(i[0]===1){let m=i.slice(1),y=[1,2],g=pr(i,m),b=["b","row","col"],_=JSON.parse(JSON.stringify(o));_.unpackedShape=g;let T=this.getPackedSamplerFromInput(n,t,_),I=`${T.routineBody}
      ...
      `;return new M(s,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler2D(n,t,o){let i=o.unpackedShape,a=[o.height,o.width];if(a!=null&&Hn.arraysEqual(i,a)){let f=a[1],h=a[0],m=`
        ...
        `;return new M(m,["coordinates.sampleTexture"])}let{newShape:s,keptDims:u}=br(i),l=s;if(l.length<i.length){let f=pr(i,l),h=JSON.parse(JSON.stringify(o));h.unpackedShape=f;let m=["col","row"],y=`
      ...
      `;return new M(p,["coordinates.uvFromFlat","coordinates.sampleTexture","coordinates.coordsToOffset"])}getUnpackedSampler3D(n,t,o){let i=o.unpackedShape,a=i[1]*i[2],s=i[2],{newShape:u,keptDims:l}=br(i),c=u;if(c.length<i.length){let h=pr(i,c),m=["batch","col","row"],y=JSON.parse(JSON.stringify(o));y.unpackedShape=h;let g=this.getUnpackedSamplerFromInput(n,t,y),b=l.reverse(),_=`
          ${g.routineBody}
      ...
      `;return new M(d,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler5D(n,t,o){let i=o.unpackedShape,a=i[4],s=i[3]*a,u=i[2]*s,l=i[1]*u,{newShape:c,keptDims:d}=br(i);if(c.length<i.length){let m=pr(i,c),y=["row","col","depth","depth2","depth3"],g=JSON.parse(JSON.stringify(o));g.unpackedShape=m;let b=`
      ...
      `;return new M(h,["coordinates.sampleTexture","coordinates.uvFromFlat"])}getUnpackedSampler6D(n,t,o){let i=o.unpackedShape,a=i[5],s=i[4]*a,u=i[3]*s,l=i[2]*u,c=i[1]*l,{newShape:d,keptDims:p}=br(i);if(d.length<i.length){let y=pr(i,d),g=["row","col","depth","depth2","depth3","depth4"],b=JSON.parse(JSON.stringify(o));b.unpackedShape=y;let _=`
    ...
    `;return{toVec:new M(u,["coordinates.coordsToOffset"])}}valueFrom(){let n={};return this.context.programInfo.inputNames.forEach((t,o)=>{let i=this.context.inputTextureLayouts[o],s=(i.unpackedShape.length>0?i.unpackedShape:i.shape).length,u=`_${t}`;n[u]=new M(this.getValueFromSingle(t,s,i.width,i.height,!1),[`shapeUtils.indicesToOffset${u}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"]),u=u+"_T",n[u]=new M(this.getValueFromSingle(t,s,i.width,i.height,!0),[`shapeUtils.indicesToOffset${u}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"])}),n}getValueFromSingle(n,t,o,i,a){let s=`_${n}`;a&&(s=s+"_T");let u=q(this.context.glContext.version);return`
        ...
        `}}});var Xo,tm=$(()=>{"use strict";Tn();Xo=class r extends ht{constructor(e){super(e)}getFunctions(){return{...this.encodeFloat32(),...this.decodeFloat32()}}getCustomTypes(){return{}}encodeFloat32(){return{encode:new M(`highp vec4 encode(highp float f) {
      ...
      `}incrementIndices(){let e={};return this.context.programInfo.inputNames.forEach((n,t)=>{let o=this.context.inputTextureLayouts[t].shape,i=o.length,a=`incrementIndices_${n}`,s="";for(let l=0;l<i;++l)s+=`
        ...
        `;e[a]=new M(u)}),e}}});var Qo,om=$(()=>{"use strict";Tn();Qo=class extends ht{constructor(e){super(e)}getCustomTypes(){return{}}getFunctions(){return{...this.binaryVecFunctions(),...this.copyVec(),...this.setVecItem(),...this.getVecItem()}}binaryVecFunctions(){let n=this.context.outputTextureLayout.shape.length,t={add:"+=",sub:"-=",mul:"*=",div:"/="},o={};for(let i in t){let a=`${i}Vec`,s="";for(let l=0;l<n;++l)s+=`
          dest[${l}] ${t[i]} src[${l}];
          `;let u=`
...
`},E1=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=xe(t[0].type.tensor);return`
  ...
  ${m?Ju(y,g,U,$e):Qu(y,g,U,$e)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${w}) {
      ...
      }`,ot=A("x",r[0].dataType,r[0].dims.length,w===3?1:w),De=A("w",r[1].dataType,r[1].dims.length,ie),de=[ot,De],z=C("result",r[0].dataType,n.length,ie);if(a){let W=A("bias",r[2].dataType,r[2].dims.length,ie);de.push(W),ve+=`
...
`,g$=(r,e,n)=>(()=>{switch(n.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${r.setByOffset("global_idx","result")}`,b$=(r,e)=>{let n=A("x",r[0].dataType,r[0].dims.length),t=[r[1].dims[0],r[1].dims[1],r[1].dims[2]],o=A("grid",r[1].dataType,t.length,2),i=[r[0].dims[0],r[0].dims[1],r[1].dims[1],r[1].dims[2]];e.format==="NHWC"&&(i=[r[0].dims[0],r[1].dims[1],r[1].dims[2],r[0].dims[3]],[wn,Nn,Tr,vr]=[0,3,1,2]);let a=C("output",r[0].dataType,i.length),s=n.type.value,u=S.size(i),l=[{type:12,data:u},...D(r[0].dims,t,i)],c=d=>`
